...
import (
	...
	"errors"
	"fmt"
	"github.com/blocktree/blockethereum-adapter/blockethereum_txsigner"
...
func (this *EthTransactionDecoder) SignRawTransaction(wrapper openwallet.WalletDAI, rawTx *openwallet.RawTransaction) error {
	...
	sig, err := blockethereum_txsigner.Default.SignTransactionHash(message, keyBytes, owcrypt.ECC_CURVE_SECP256K1)
	if err != nil {
